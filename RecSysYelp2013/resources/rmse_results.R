...
calculateError = function(col){
   ...
   pr8 = pRmse(preference_hybrid_w,col)
   x = data.frame(preference_1_rmse = pr1, preference_2_rmse = pr2,
                  ...
                  preference_3_hybrid_rmse = pr7, preference_3_hybrid_w_rmse = pr8)
}
...
row.names(existingDFT) = c("pref1","pref2","pref3","pref4","pref5","pref6","pref_h","pref_h_w")
