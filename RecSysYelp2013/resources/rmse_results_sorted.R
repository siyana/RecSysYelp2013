...
existingDFS = rbind(existingDFS,calculateErrorS(preference_hybrid, preference6, preference1, preference5))
existingDFS = rbind(existingDFS,calculateErrorS(preference_hybrid_w, preference3, preference2, preference6))
...
row.names(svdPar ) = c("1","2","3","4","5","6","7","8","9")
...
svdPlPlPar = rbind(svdPlPlPar,calculateSVDErr(preference_hybrid, preference1))
svdPlPlPar = rbind(svdPlPlPar,calculateSVDErr(preference_hybrid_w, preference2))
svdPlPlPar = rbind(svdPlPlPar,calculateSVDErr(preference7, preference5))
svdPlPlPar = rbind(svdPlPlPar,calculateSVDErr(preference5, preference4))
svdPlPlPar = rbind(svdPlPlPar,calculateSVDErr(preference6, preference6))

row.names(svdPlPlPar ) = c("1","2","3","4","5","6","7","8","9")
resultsPath = "E:\\Projects\\Workspace\\RecSysYelp2013\\RecSysYelp2013\\RecSysYelp2013\\resources\\mapped\\rmse_results_svd++.csv"
